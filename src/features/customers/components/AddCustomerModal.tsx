    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 flex-shrink-0">
          <div>
            <h2 className="text-base font-bold text-slate-900">Thêm khách hàng</h2>
            <p className="text-xs text-slate-400 mt-0.5">Thêm khách hàng mới vào hệ thống</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={3}
              className={cn(
                "w-full px-4 py-3 rounded-xl text-sm bg-slate-50 border border-slate-200 text-slate-800 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition-all resize-none"
              )}
            />
          </div>
        </div>
